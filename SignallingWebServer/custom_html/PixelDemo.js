...
function setBandwidthCap(cap) {	
    capBpsCmd = cap > -1 ? 'PixelStreaming.Encoder.TargetBitrate ' + cap * 1000000 : 'PixelStreaming.Encoder.TargetBitrate -1';
    let descriptor = {
        Console: capBpsCmd
    }
    capStr = cap != -1 ? cap + ' Mbps' : 'WebRTC Decides';
    document.getElementById('bandwidthCapDropdown').innerHTML = 'Bandwidth Cap (' + capStr + ')&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
    emitUIInteraction(descriptor);
    console.log(descriptor);
}
